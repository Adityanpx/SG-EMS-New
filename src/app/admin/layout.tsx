...
import {
  ...
  ClipboardList, Megaphone, Menu, X,
    ...
    <div className="flex h-screen bg-slate-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-[60px] bg-white border-b border-slate-100 flex items-center gap-4 px-5 shrink-0">
          ...
          {/* Right: ADMIN MODE badge + Bell + User */}
          <div className="flex items-center gap-3">
            {/* Figma "ADMIN MODE" pink pill */}
            <span className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1 bg-pink-50 border border-pink-200 text-pink-600 text-xs font-bold rounded-full uppercase tracking-wider">
              ⚡ Admin Mode
            </span>
            <NotificationBell />
